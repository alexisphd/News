...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item text-center align-items-center ">
                <i class="nav-link">Вы вошли как: <span class="text-danger">Пользователь</span></i>
            </li>
        </ul>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2023 <a href="#">Личный кабинет</a>.</strong>
